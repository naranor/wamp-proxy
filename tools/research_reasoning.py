...
def run_step_3_reasoning():
    print("=== STEP 3: REASONING (MULTI-DOC QA) RESEARCH ===")
    ...
    critical_indices = [1, 15, 29, 43, 57, 71, 113]  # Fragment locations
    ...
    with open("benchmarks/RESEARCH_REASONING.md", "w") as f:
        f.write("# Research Step 3: Reasoning Audit (114 msgs)\n")
        f.write("**Model:** DeBERTa-v3-small-NLI (INT8)\n\n")
        for algo in algorithms:
            f.write(f"### Algorithm: {algo}\n")
            f.write("| Multiplier | Compression % | Recall (Logic) % | Status |\n")
            f.write("| :--- | :--- | :--- | :--- |\n")
    ...
    print("🚀 Research results saved to benchmarks/RESEARCH_REASONING.md")
