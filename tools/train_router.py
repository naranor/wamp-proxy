...
def train_all_classifiers():
    ...
    clf_n = LogisticRegression(max_iter=5000, C=1.0, class_weight="balanced").fit(
    ...
    clf_r = LogisticRegression(max_iter=5000, C=1.0, class_weight="balanced").fit(
        np.array(X), np.array(y)
    )
