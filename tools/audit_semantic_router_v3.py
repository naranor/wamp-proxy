...
def audit_semantic_router_v3():
    print("=== AUDIT: ENHANCED SEMANTIC ROUTER V3 (2311d FEATURES) ===")
    ...
    inv_map = {v: k for k, v in weights["label_map"].items()}
    ...
    for query in test_queries:
        ...
        print(f"{query[:43]:<45} | {probs[0]:.3f}   | {probs[1]:.3f}   | {probs[2]:.3f}   | {inv_map[winner_idx]}")

if __name__ == "__main__":
    logging.getLogger("wamp").setLevel(logging.ERROR)
    audit_semantic_router_v3()
