...
def tune_needle_detector():
    ...
    dataset = {
        "Needle": [
            "What is the port?", "API key?", "Database secret.", "JWT expiry.", "Admin pass?",
            "What is the port number for the database?", "Give me the API key mentioned earlier.",
            "What was the backup encryption password?", "Find the lead scientist name.",
            "Identify the server IP from the logs.", "Port?", "Key?", "Secret?", "Password?",
            "What is the database port?", "Show me the encryption key.", "Find the API secret."
        ],
        "Non-Needle": [
            "Summarize our talk.", "Compare Alpha and Beta.", "Why did it fail?", "Recap the main points.",
            "Explain the architecture.", "Analyze the budget.", "Give me an overview.",
            "How does Kubernetes work?", "Write a report.", "TL;DR.", "Compare projects.",
            "Synthesize the team structure.", "Evaluation of monitoring.", "Contrast pipelines.",
            "What is the general topic?", "Briefly outline the system.", "Technical synopsis."
        ]
    }
