...
from src.wamp.core.config import FILTER_NEEDLE_MULT, FILTER_REASONING_MULT, FILTER_SUMMARY_MULT
...
def run_large_validation():
    ...
    for name, data in scenarios.items():
        ...
        if category == "Reasoning": algo = "cls_max"
        elif category == "Needle": algo = "mean_max"
        else: algo = "mean_mean"
