...
def audit_stage1_composite():
    ...
    test_suite = {
        "Needle (Positive)": [
            "What is the port?", "Show me the secret key.", "What's the password?",
            "Find the DB connection string.", "API token?", "Backup encryption key?",
            "Identify the server IP.", "Port number for the cluster?", "JWT secret?",
            "What is the value of the constant?"
        ],
        "Other (Negative)": [
            "Summarize the chat.", "Compare Alpha and Beta.", "Analyze the logs.",
            "Write a concise report.", "Why was Gamma cancelled?", "Explain the auth flow.",
            "How does Kubernetes work?", "Give me an overview.", "TL;DR of the session.",
