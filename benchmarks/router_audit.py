...
def audit_full_composite_router():
    ...
    test_suite = {
        ...
        "Reasoning": [
            ...
            "Synthesize the team roles from fragments.",
            "Why did the database fail?",
            "Cross-reference logs with system events.",
            "Critique the security design.",
            "Which scientist has more experience?",
        ...
        "Summary": [
            ...
            "Wrap up the spec.",
            "Technical synopsis of the project.",
            "Recap the infrastructure setup.",
            "Condensed version of our talk.",
            "Main takeaways from the chat?",
    ...
    for category, queries in test_suite.items():
        for query in queries:
            ...
            print(
                f"{category:<15} | {predicted:<12} | {'✅' if is_correct else '❌'} | {query[:40]}"
            )
